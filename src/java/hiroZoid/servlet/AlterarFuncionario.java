...
import hiroZoid.dao.FuncionarioDAO;
...
public class AlterarFuncionario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        funcionario.setCodigoFuncionario(Integer.parseInt(request.getParameter("codigoFuncionario")));
        ...
        if (Helper.INSTANCE.isSet(request.getParameter("salario"))) {
        ...
        if (Helper.INSTANCE.isSet(request.getParameter("nroAmbulatorio"))) {
            funcionario.setNroAmbulatorio(Integer.parseInt(request.getParameter("nroAmbulatorio")));
        }

        FuncionarioDAO funcionarioDAO = new FuncionarioDAO();
        if (funcionarioDAO.alterar(funcionario) == 0) {
